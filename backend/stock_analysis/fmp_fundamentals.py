...
class FMPFundamentals:
    ...
    def _get_fmp_data(symbol: str, endpoint: str) -> list[dict]:
    ...
    @cached_property
    def income_data(self): return self._get_fmp_data(self.symbol, "income-statement")

    @cached_property
    def balance_data(self): return self._get_fmp_data(self.symbol, "balance-sheet-statement")

    @cached_property
    def cashflow_data(self): return self._get_fmp_data(self.symbol, "cash-flow-statement")

    @cached_property
    def profile_data(self): return self._get_fmp_data(self.symbol, "profile")

    @cached_property
    def quote_data(self): return self._get_fmp_data(self.symbol, "quote")

    @cached_property
    def ratios_data(self): return self._get_fmp_data(self.symbol, "ratios")


    # === Metrics ===
    def revenue(self) -> Optional[float]:
        return self.income_data[0].get("revenue") if self.quote_data else None
